...
According to the judgement passed by the Supreme Court, it is not compulsory to link your Aadhaar to bank accounts. Nevertheless, Aadhaar is obligatory for filing of Income Tax returns and assigning of Permanent Account Number
You need to give your Aadhaar number to avail the government welfare schemes and subsidies for example: LPG, kerosene, and various scholarships
No child must be denied benefits of any programs for not being able to bring their Aadhaar card number. This is as per Supreme Court’s judgment
It is also not mandatory to link your mobile number with the bank accounts, however by doing so, you can complete the financial and other transactions in a secured manner
If you have an Aadhaar card and your mobile number is registered with your aadhaar records, with the Unique Identification Authority of India or UIDAI), it helps you to have a smoother financial lifecycle. 
Knowing the several importance, usages and advantages of aadhar card and its growing acceptance, it would be beneficial to have an Aadhaar to avail of the benefits. Also, as a responsible citizen of India, let us aim to make this country a strong governing digitally advanced country by accepting and utilization of Aadhaar Card to the fullest extent.
